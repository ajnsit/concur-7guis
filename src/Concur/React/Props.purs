...
unsafeTargetValue :: forall event. event -> String
...
foreign import resetValue :: forall inputElement. String -> inputElement -> Effect Unit
...
foreign import data RRef :: Type
foreign import createRef :: Effect RRef
foreign import refSetter :: RRef -> Nullable ReactRef -> Effect Unit
foreign import refGetter :: RRef -> Effect (Nullable ReactRef)

ref :: forall a. RRef -> Props a -- (Nullable ReactRef)
ref = PrimProp <<< P.ref <<< refSetter
