...
effAction eff = Widget $ liftF $ WidgetStep $ map Left eff

-- | Deprecated. Use `liftEffect`
unsafeBlockingEffAction :: forall a v. Effect a -> Widget v a
unsafeBlockingEffAction = effAction
...
-- Primitive Widget Construction combinators -------------------
...
-- High Level Monadic combinators -------------------
